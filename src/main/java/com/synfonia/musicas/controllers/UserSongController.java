...
import com.synfonia.musicas.services.UserSongService;
...
public class UserSongController {
    ...
    @PostMapping
    public ResponseEntity<UserSong> adicionarMusica(@RequestBody com.synfonia.musicas.dtos.request.MusicSaveRequest request) {
