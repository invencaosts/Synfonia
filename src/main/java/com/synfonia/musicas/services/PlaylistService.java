...
import com.synfonia.musicas.exceptions.SpotifyApiException;
...
public class PlaylistService {
    ...
    public Playlist importPlaylistData(com.synfonia.musicas.dtos.request.SpotifyImportDataRequest request) {
        Long userId = getLoggedUserId();

        boolean isSpotifyImport = request.getSource() == null || "SPOTIFY".equals(request.getSource());
        com.synfonia.musicas.enums.MusicSource trackSource = isSpotifyImport
                ? com.synfonia.musicas.enums.MusicSource.SPOTIFY
                : com.synfonia.musicas.enums.MusicSource.valueOf(request.getSource());

        List<com.synfonia.musicas.dtos.request.SpotifyImportDataRequest.SpotifyTrackData> tracks = request.getTracks();
        ...
        Playlist playlist = Playlist.builder()
                ...
                .vibe(isSpotifyImport ? "Sincronizada do Spotify" : "Sincronizada do YouTube Music")
                .publico(false)
                .userId(userId)
                .capaUrl(request.getCapaUrl())
                .syncSpotify(isSpotifyImport)
    ...
    private List<com.synfonia.musicas.dtos.request.SpotifyImportDataRequest.SpotifyTrackData> fetchSpotifyTracks(String spotifyPlaylistId, String token) {
        ...
        try {
            ...
            java.util.List<com.synfonia.musicas.dtos.request.SpotifyImportDataRequest.SpotifyTrackData> tracks = new java.util.ArrayList<>();
            if (response != null && response.has("items")) {
                for (var item : response.get("items")) {
                    ...
                    tracks.add(com.synfonia.musicas.dtos.request.SpotifyImportDataRequest.SpotifyTrackData.builder()
    ...
    public Long getLoggedUserId() {
        ...
        if (auth == null || !(auth.getPrincipal() instanceof com.synfonia.musicas.security.UsuarioDetails details)) {
