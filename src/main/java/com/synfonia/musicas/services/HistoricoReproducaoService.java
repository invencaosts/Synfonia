...
import com.synfonia.musicas.repositories.HistoricoReproducaoRepository;
...
public class HistoricoReproducaoService {
    ...
    public void adicionarAoHistorico(Long userId, String trackId, com.synfonia.musicas.dtos.request.MusicSaveRequest request) {
    ...
    public List<HistoricoResponse> obterHistoricoRecente(Long userId) {
        ...
        return historicos.stream().map(historico -> {
            try {
                ...
                com.synfonia.musicas.dtos.response.MusicResponse placeholder = com.synfonia.musicas.dtos.response.MusicResponse.builder()
